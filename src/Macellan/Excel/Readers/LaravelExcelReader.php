<?php namespace Macellan\Excel\Readers;
...
use Macellan\Excel\Collections\RowCollection;
use Macellan\Excel\Collections\SheetCollection;
use PHPExcel_Cell;
...
use Macellan\Excel\Parsers\ExcelParser;
...
class LaravelExcelReader
{
     ...
     * The parsed file
     *
     * @var \Macellan\Excel\Collections\RowCollection|\Macellan\Excel\Collections\SheetCollection
     */
    public $parsed;
